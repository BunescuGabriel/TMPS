...
class Carte(Resursa):
    ...
    def afisare(self):
        print(
            f"Aceasta este cartea '{self.titlu}' scrisă de '{self.autor}' editata de {self.editara}")
...
class Muzica(Resursa):
    ...
    def afisare(self):
        print(
            f"Acesta este un album muzical '{self.autor}' anul aparitii este {self.an_aparitie}")
